...
%% function
function yesorno = do1polygon1circleIntersect(VerticesNx2,center,r)
%in 2D
%Vertices must be ordoned in one sense or another!
...
for i=1:m %vertex 1
        disp(['i = ',num2str(i)])
    j=i+1 ; if j>m ; disp('j>m') ; j=1 ; end %vertex 2
        disp(['j = ',num2str(j)])
...
if flag == 0
%Does the circle lies within the polygon?
