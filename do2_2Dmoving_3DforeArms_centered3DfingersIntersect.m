...
[Dq2,a2forIK]= perpendicularDecenteringEE(dimsArms(1,6),lenFore+projectedLenFing);

% function yesorno = do2_2Dmoving_3DforeArmsIntersect(argx8,rx2,dimsArms,orig1,orig2,durx2,whichAngle,Dq2,a2forIK,display)
...
%         Q1(i,:) = IKright2RarmWithoutAlKashi(P1fromOrigin1,a1_1,a2forIK);
%         Q1(i,2) = Q1(i,2)-Dq2;
%         disp(['Q1(',num2str(i),',:) = ',num2str(Q1(i,:)*180/pi)])
        Q2(i,:) = IKright2RarmWithoutAlKashi(P2fromOrigin2,a1_2,a2_2+projectedLenFing);
%         Q2(i,:) = IKright2RarmWithoutAlKashi(P2fromOrigin2,a1_2,a2forIK);
%         Q2(i,2) = Q2(i,2)-Dq2;
...
%         posJoints1(i,:) = [posStart1 something posEnd1];
        Met1(i,:) = Elb1(i,:) + [a2_1*cos(sum(Q1(i,:))) , a2_1*sin(sum(Q1(i,:)))];
        Met2(i,:) = Elb2(i,:) + [a2_2*cos(sum(Q2(i,:))) , a2_2*sin(sum(Q2(i,:)))];
        ...
        if GJK(Fing1obj,Fing2obj,iterationsAllowed)
            fingers = 1; yesorno = 1; break; end
        if GJK(Fing1obj,Fore2obj,iterationsAllowed)
            fing1fore2 = 1; yesorno = 1; break; end
        if GJK(Fing2obj,Fore1obj,iterationsAllowed)
            fing2fore1 = 1; yesorno = 1; break; end
...
%         if j==1 ; pause(20) ; end %debug
            ...
            && (yesorno == 1)
                ...
                if finger1arm2;set(finger1,'FaceColor','r'); set(arm2,'Color','r'); end
                if finger2arm1;set(finger2,'FaceColor','r'); set(arm1,'Color','r'); end
