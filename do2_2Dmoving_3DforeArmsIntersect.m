...
function yesorno = do2_2Dmoving_3DforeArmsIntersect(argx8,rx2,dimsArms,orig1,orig2,durx2,display)
...
a2_1 = dimsArms(1,2); %length 1st arm
...
toBeTransformed = [templateForeV';ones(1,size(templateForeV,1))];
